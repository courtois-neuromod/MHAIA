...
def main(args: argparse.Namespace) -> None:
    ...
    data = load_action_data('train', iterations, method, n_actions, seeds, sequence, args.data_folder)
    ...
    total_actions = total_actions / np.sum(total_actions) * args.episode_length

    fig = plt.figure(figsize=(13, 5))
    y_label = "Actions/Episode"
    ...
    stackplot.set_ylim(0, args.episode_length)
