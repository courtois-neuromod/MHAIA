...
class World5(MarioEnv):
    """
    World 5 of Super Mario Bros - The Cloud World

    This world emphasizes vertical platforming and aerial challenges.

    Stages:
    - Level5-1: Mixed terrain with elevated platforms
    - Level5-2: Underground with Bullet Bills
    - Level5-3: Cloud platforms at high altitude
    - Level5-4: Maze-like castle with multiple paths
    ...
    # Level names for each stage in World 5
    TASKS = ['Level5-1', 'Level5-2', 'Level5-3', 'Level5-4']
    ...
    def __init__(self,
        ...
        """
        Initialize World 5 environment.
