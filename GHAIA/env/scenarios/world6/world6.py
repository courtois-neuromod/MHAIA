...
class World6(MarioEnv):
    """
    World 6 of Super Mario Bros - The Ice World

    This world introduces slippery ice physics and increased enemy density.

    Stages:
    - Level6-1: Overground with ice blocks and Lakitu
    - Level6-2: Underground ice caves
    - Level6-3: Icy tree platforms with Hammer Bros
    - Level6-4: Castle with precise timing requirements
    ...
    # Level names for each stage in World 6
    TASKS = ['Level6-1', 'Level6-2', 'Level6-3', 'Level6-4']
    ...
    def __init__(self,
        ...
        """
        Initialize World 6 environment.
