...
class World3(MarioEnv):
    """
    World 3 of Super Mario Bros - The Night World

    This world features nighttime levels with varying terrain and increased difficulty.

    Stages:
    - Level3-1: Night overground with more aggressive enemies
    - Level3-2: Night underground with tighter platforming
    - Level3-3: Treeto  level with moving platforms at night
    - Level3-4: Castle level with challenging fire bar arrangements
    ...
    # Level names for each stage in World 3
    TASKS = ['Level3-1', 'Level3-2', 'Level3-3', 'Level3-4']
    ...
    def __init__(self,
        ...
        """
        Initialize World 3 environment.
