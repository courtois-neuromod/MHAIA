...
class World4(MarioEnv):
    """
    World 4 of Super Mario Bros - The Mushroom World

    This world focuses on island and mushroom platform navigation.

    Stages:
    - Level4-1: Islands with water gaps and precise jumping
    - Level4-2: Underground with varied enemy placement
    - Level4-3: High-altitude mushroom platforms
    - Level4-4: Complex castle with long fire bar corridors
    ...
    # Level names for each stage in World 4
    TASKS = ['Level4-1', 'Level4-2', 'Level4-3', 'Level4-4']
    ...
    def __init__(self,
        ...
        """
        Initialize World 4 environment.
