...
class World1(MarioEnv):
    """
    World 1 of Super Mario Bros - The Classic Adventure

    This world represents the iconic first world of Super Mario Bros. Mario must navigate through
    four progressive stages (1-1, 1-2, 1-3, 1-4), learning basic platforming mechanics, enemy avoidance,
    and goal completion. Each stage increases in difficulty.

    Stages:
    - Level1-1: Overground level, introduces basic mechanics
    - Level1-2: Underground level with different enemy patterns
    - Level1-3: Tree-top level with moving platforms
    - Level1-4: Castle level with fire bars and Bowser
    ...
    # Level names for each stage in World 1
    ...
    def __init__(self,
        ...
        """
        Initialize World 1 environment.
    ...
    def performance_upper_bound(self) -> float:
        ...
        Based on typical level completion (~3100 for 1-1).
        """
        level_bounds = {
            'Level1-1': 3200,
            'Level1-2': 3200,
