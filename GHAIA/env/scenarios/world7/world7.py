...
class World7(MarioEnv):
    """
    World 7 of Super Mario Bros - The Pipe World

    This world features heavy pipe navigation and Piranha Plant challenges.

    Stages:
    - Level7-1: Dense pipe layout with many Piranha Plants
    - Level7-2: Underground pipe maze
    - Level7-3: Elevated platforms with pipe obstacles
    - Level7-4: Complex castle with Bowser's hammers
    ...
    # Level names for each stage in World 7
    TASKS = ['Level7-1', 'Level7-2', 'Level7-3', 'Level7-4']
    ...
    def __init__(self,
        ...
        """
        Initialize World 7 environment.
