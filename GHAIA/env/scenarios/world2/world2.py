...
class World2(MarioEnv):
    """
    World 2 of Super Mario Bros - The Water World

    This world introduces water-based gameplay with swimming mechanics and underwater enemies.
    Stages progress from land-water transitions to fully submerged levels.

    Stages:
    - Level2-1: Mixed overground and underwater sections
    - Level2-2: Full underwater level with Bloopers and Cheep-Cheeps
    - Level2-3: Overground level with high platforms
    - Level2-4: Castle level with more complex fire bar patterns
    ...
    # Level names for each stage in World 2
    TASKS = ['Level2-1', 'Level2-2', 'Level2-3', 'Level2-4']
    ...
    def __init__(self,
        ...
        """
        Initialize World 2 environment.
